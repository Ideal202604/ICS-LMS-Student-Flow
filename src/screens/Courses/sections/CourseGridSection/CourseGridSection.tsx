...
const metaIcons = {
  lessons: "https://c.animaapp.com/mnx35q56jSrTot/img/frame-3.svg",
  mode: "https://c.animaapp.com/mnx35q56jSrTot/img/frame-2.svg",
  duration: "https://c.animaapp.com/mnx35q56jSrTot/img/frame-5.svg",
};
...
export const CourseGridSection = (): JSX.Element => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 w-full px-4 md:px-8 lg:px-16 pt-12 sm:pt-20 pb-8 sm:pb-12">
            ...
            <div className="relative w-full h-[180px] sm:h-[205px]">
              ...
              <div className="flex w-[70px] h-8 items-center gap-2 px-[5px] py-0 absolute bottom-[11px] right-[11px] bg-white rounded-lg">
                <img
                  className="w-4 h-4"
                  alt="Star"
                  src="https://c.animaapp.com/mnx35q56jSrTot/img/frame-6.svg"
                />
            ...
            <div className="flex w-full items-center justify-between">
              ...
              <div className="inline-flex items-center justify-center gap-1.5 sm:gap-2.5 px-2 sm:px-2.5 py-1.5 sm:py-2 bg-[#fee9cd] rounded-[20px]">
                <img
                  ...
                  alt="Discount"
                  src="https://c.animaapp.com/mnx35q56jSrTot/img/frame.svg"
                />
            ...
            <div className="inline-flex items-center gap-3 sm:gap-4 w-full justify-center flex-wrap">
              ...
              >
                <img
                  className="w-5 h-5 sm:w-6 sm:h-6"
                  alt="Details"
                  src="https://c.animaapp.com/mnx35q56jSrTot/img/frame-1.svg"
                />
              ...
              >
                <img
                  className="w-5 h-5 sm:w-6 sm:h-6"
                  alt="Start Learning"
                  src="https://c.animaapp.com/mnx35q56jSrTot/img/frame-4.svg"
                />
