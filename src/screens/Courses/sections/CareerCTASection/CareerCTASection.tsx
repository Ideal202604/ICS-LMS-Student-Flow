...
export const CareerCTASection = (): JSX.Element => {
  ...
  return (
    <section className="w-full px-4 sm:px-6 md:px-8 lg:px-12 pt-4 md:pt-8 pb-16 md:pb-24 bg-white">
          ...
          >
            <CardContent className="flex flex-col w-full items-stretch gap-0 p-0">
              ...
              <div className="relative w-full h-[240px] md:h-[260px] overflow-hidden">
                ...
                />
                {/* Rating Badge */}
                <div className="flex w-[75px] h-9 items-center gap-1.5 px-2 py-1.5 absolute bottom-3 right-3 bg-white rounded-lg shadow-[0px_2px_4px_rgba(0,0,0,0.08)]">
                  <img className="w-4 h-4" alt="Star rating" src="https://c.animaapp.com/mnmyaijxgewU4q/img/frame-1.svg" />
                  <span className="font-semibold text-[#1a365d] text-sm leading-5 [font-family:'Open_Sans',Helvetica] tracking-[-0.14px]">
                    {course.rating}
                  </span>
                </div>
              </div>
              ...
              {/* Content Section */}
              <div className="flex flex-col items-start gap-6 p-6 md:p-7 self-stretch w-full">
                {/* Title and description */}
                <div className="flex flex-col items-start gap-4 self-stretch w-full">
                  <h3 className="self-stretch [font-family:'Open_Sans',Helvetica] font-bold text-[#1a365d] text-xl md:text-2xl tracking-[-0.28px] leading-8">
                    {course.title}
                  </h3>
                  <p className="self-stretch [font-family:'Open_Sans',Helvetica] font-normal text-[#55596a] text-base md:text-lg tracking-[-0.14px] leading-7">
                    {course.description}
                  </p>
                </div>
                ...
                <div className="gap-3 md:gap-4 inline-flex items-center flex-wrap w-full">
                  <div className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-[#e9f6ff] rounded-lg border border-[#b8d9f1]">
                    <img className="w-4 h-4" alt="Lessons" src={metaBadgeIcons[0].src} />
                  ...
                  <div className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-[#e9f6ff] rounded-lg border border-[#b8d9f1]">
                    <img className="w-4 h-4" alt="Mode" src={metaBadgeIcons[1].src} />
                    <span className="[font-family:'Open_Sans',Helvetica] font-semibold text-[#0072de] text-xs md:text-sm tracking-[-0.14px] leading-5 whitespace-nowrap">
                      {course.mode}
                    </span>
                  </div>
                  <div className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-[#e9f6ff] rounded-lg border border-[#b8d9f1]">
                    <img className="w-4 h-4" alt="Duration" src={metaBadgeIcons[2].src} />
                    <span className="[font-family:'Open_Sans',Helvetica] font-semibold text-[#0072de] text-xs md:text-sm tracking-[-0.14px] leading-5 whitespace-nowrap">
                      {course.duration}
                    </span>
                  </div>
                ...
                <div className="flex w-full items-center justify-between gap-4 pt-2">
                  <div className="inline-flex items-center gap-3">
                    <span className="font-normal text-[#9ca3af] text-base md:text-lg text-start leading-7 line-through [font-family:'Open_Sans',Helvetica] tracking-[-0.14px]">
                      {course.originalPrice}
                    </span>
                    <span className="font-bold text-[#1a365d] text-xl md:text-2xl leading-8 [font-family:'Open_Sans',Helvetica] tracking-[-0.28px]">
                ...
                <div className="gap-3 inline-flex items-center w-full justify-center flex-wrap pt-2">
                  <Button
                    ...
                    className="h-12 md:h-13 gap-2 px-6 md:px-7 py-3 bg-white rounded-lg border border-[#0072de] text-[#0072de] inline-flex items-center transition-all hover:bg-[#e9f6ff] active:scale-95"
                  >
                    <img className="w-5 h-5" alt="Details icon" src="https://c.animaapp.com/mnmyaijxgewU4q/img/frame-8.svg" />
                  ...
                  <Button
                    ...
                    className="h-12 md:h-13 gap-2 px-6 md:px-7 py-3 bg-[#0072de] rounded-lg border border-[#0072de] shadow-[0px_4px_12px_rgba(0,72,222,0.25)] text-white inline-flex items-center justify-center transition-all hover:bg-[#005bbf] active:scale-95"
                  >
                    <img className="w-5 h-5" alt="Start Learning icon" src="https://c.animaapp.com/mnmyaijxgewU4q/img/frame.svg" />
