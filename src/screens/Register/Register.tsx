...
export const Register = (): JSX.Element => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#eff7ff]">
      {/* Navigation Bar */}
      <header className="w-full h-[81px] bg-white flex items-center justify-between px-4 md:px-8 lg:px-16 xl:px-[264px] flex-shrink-0 z-10 relative">
        {/* Logo */}
        <img
      ...
      <main className="flex-1 w-full bg-[#eff7ff] relative">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-stretch px-4 md:px-8 lg:px-16 xl:px-[264px] py-8 md:py-12 lg:py-[100px] gap-0">
          {/* Left panel - student photo */}
          <div className="flex-shrink-0 w-full lg:w-1/2">
            <img
              className="w-full h-[300px] sm:h-[400px] lg:h-[1025px] object-cover rounded-t-[30px] lg:rounded-t-none lg:rounded-l-[30px]"
              alt="Students"
          ...
          <div className="flex-1 relative min-h-[600px] lg:min-h-[1025px]">
            <img
              className="absolute top-0 left-0 w-full h-full object-cover"
              alt="Background"
              src="https://c.animaapp.com/mnwvehj5NMc2G7/img/rectangle-39422.svg"
            />
            <div className="relative z-10 w-full h-full flex items-center justify-center px-4 sm:px-8 lg:px-12 py-8 md:py-12">
