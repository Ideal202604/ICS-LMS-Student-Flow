export const MissionVisionSection = (): JSX.Element => {
  return (
    <div className="flex flex-col items-start gap-6 w-full max-w-[602px]">
      <div className="flex flex-col items-start gap-4 self-stretch w-full">
        <h2 className="self-stretch mt-[-1.00px] [font-family:'Open_Sans',Helvetica] font-semibold text-black text-[44px] tracking-[-0.88px] leading-[52px]">
          Our Vision
        </h2>
