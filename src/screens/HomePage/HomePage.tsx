...
import { ExploreCoursesSectionHP } from "./sections/ExploreCoursesSectionHP";
...
const navItems = [
  { label: "Home", icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-56.svg", active: true, href: "/" },
  { label: "Courses", icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-34.svg", active: false, href: "/courses" },
  { label: "About", icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-39.svg", active: false, href: "/about" },
  { label: "Contact", icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-60.svg", active: false, href: "/contact" },
];

const whyChooseUsCards = [
  {
    icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/vector.svg",
    iconWidth: "w-[65px]",
    iconHeight: "h-[54px]",
  ...
  {
    icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/vector-1.svg",
    iconWidth: "w-14",
    iconHeight: "h-[54px]",
  ...
  {
    icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/group.png",
    iconWidth: "w-[45.84px]",
    iconHeight: "h-[54px]",
  ...
  {
    icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/group-1.png",
    iconWidth: "w-[44.92px]",
    iconHeight: "h-[55px]",
...
export const HomePage = (): JSX.Element => {
  ...
  return (
    <div className="relative w-full bg-white overflow-x-hidden flex flex-col">
      ...
      {/* ── Hero Banner Section ── */}
      <section className="relative w-full min-h-[320px] sm:min-h-[420px] md:min-h-[540px] lg:min-h-[655px] flex items-center overflow-hidden">
      ...
      <section className="w-full relative bg-white py-8 sm:py-10">
        <div className="flex flex-col items-center gap-3 sm:gap-4 pb-6 sm:pb-8 px-3 sm:px-6 section-animate">
        ...
        <div className="flex items-center justify-center py-6 sm:py-8">
          ...
          >
            ...
            <img
              className="w-6 h-6"
              alt="Frame"
              src="https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-8.svg"
            />
          </button>
        </div>
      </section>

      {/* ── Explore Our All Courses Section ── */}
      <section className="w-full relative bg-white py-8 sm:py-10">
        <div className="flex flex-col items-center gap-3 sm:gap-4 pb-6 sm:pb-8 px-3 sm:px-6 section-animate">
          <h2 className="[font-family:'Open_Sans',Helvetica] font-semibold text-black text-[28px] sm:text-[36px] md:text-[44px] text-center tracking-[-0.88px] leading-[36px] sm:leading-[44px] md:leading-[52px] w-full max-w-[883px]">
      ...
      <section className="w-full relative" style={{ background: "linear-gradient(180deg, #0072de 0%, #01529f 100%)" }}>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch justify-center gap-6 sm:gap-8 pb-8 sm:pb-12 px-3 sm:px-6 md:px-8 lg:px-16 xl:px-[200px] 2xl:px-[264px]">
          ...
          <div className="flex-shrink-0 w-full max-w-[435px] flex items-center justify-center">
            <img
              ...
              alt="Rectangle"
              src="https://c.animaapp.com/mnyh1m5aMKY8e5/img/rectangle-39407.png"
            />
          </div>
          {/* Right cards */}
          <div className="flex flex-col gap-6 flex-1">
      ...
      <section className="w-full relative bg-white">
        ...
        <div className="relative flex items-center justify-center px-3 sm:px-6 md:px-8 lg:px-16 xl:px-[200px] 2xl:px-[264px] pb-8 sm:pb-12 gap-3 sm:gap-4">
