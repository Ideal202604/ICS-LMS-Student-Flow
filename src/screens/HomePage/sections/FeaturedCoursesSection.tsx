...
const courses = [
  {
    ...
    badges: [
      { icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-3.svg", label: "47 Lesson" },
      { icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame.svg", label: "Online" },
      { icon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-1.svg", label: "3 Months" },
    ],
    originalPrice: "₹1,500",
    currentPrice: "₹499",
    discount: "67% OFF",
    discountIcon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-7.svg",
    detailsIcon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-17.svg",
    startIcon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-6.svg",
    ratingIcon: "https://c.animaapp.com/mnyh1m5aMKY8e5/img/frame-5.svg",
  },
  {
    id: 2,
          ...
          <CardContent className="p-0 flex flex-col w-full items-center gap-6">
            ...
            <div className="flex items-center gap-2 sm:gap-3 w-full">
              <Button
                ...
                className="btn-animate flex-1 h-auto flex items-center justify-center gap-2 sm:gap-2.5 px-3 sm:px-6 py-2.5 sm:py-3 bg-white rounded-xl border border-solid border-[#8ab5dd] hover:bg-gray-50"
              >
