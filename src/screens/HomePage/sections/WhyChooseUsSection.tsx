      ...
      >
        <div className="flex flex-col items-center gap-6 max-w-[883px] w-full">
          ...
          <div className="flex items-center gap-4 sm:gap-6 flex-wrap justify-center">
            <Button className="btn-animate h-auto inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-2.5 sm:py-3 bg-[#117ade] rounded-xl border border-solid border-[#8ab5dd] shadow-[0px_3px_4px_#00000040] hover:bg-[#0f6bc7]">
