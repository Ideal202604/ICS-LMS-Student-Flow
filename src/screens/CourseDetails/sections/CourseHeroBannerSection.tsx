...
export const CourseHeroBannerSection = ({
  ...
  return (
    <>
    <div className="flex flex-col w-full max-w-[696px] items-start gap-6">
      <div className="flex flex-col items-start gap-8 w-full">
        <div className="flex flex-col items-start gap-6 w-full">
          ...
          <div className="flex flex-col items-start gap-4 w-full">
            <h1 className="w-full [text-shadow:0px_3px_4px_#00000040] font-semibold text-[44px] leading-[54px] [font-family:'Open_Sans',Helvetica] text-white tracking-[0]">
              {title}
            </h1>
            <p className="w-full [font-family:'Open_Sans',Helvetica] font-normal text-white text-lg tracking-[0] leading-7">
              {description}
            </p>
          </div>
        </div>
          ...
          {courseStats.map((stat, index) => (
            <div key={index} className="inline-flex items-center gap-4">
              ...
              <div className="flex flex-col items-start">
                <span className="[font-family:'Open_Sans',Helvetica] font-semibold text-white text-xl tracking-[0] leading-7 whitespace-nowrap">
                  {stat.value}
                </span>
                <span className="[font-family:'Open_Sans',Helvetica] font-normal text-white text-lg tracking-[0] leading-7">
                  {stat.label}
                </span>
              </div>
            </div>
        ...
        <div className="flex flex-wrap items-center gap-8">
          <div className="[font-family:'Open_Sans',Helvetica] font-normal text-white text-2xl tracking-[0] leading-7 whitespace-nowrap">
            <span className="line-through">{originalPrice}</span>
            <span className="font-semibold text-[32px]"> {discountedPrice} inc. tax</span>
          </div>
          <div className="inline-flex items-center gap-4">
            <div className="inline-flex items-center justify-center gap-2 px-2.5 py-1 bg-success-correct-answers rounded-lg">
              ...
              />
              <span className="[font-family:'Open_Sans',Helvetica] font-semibold text-app-background text-lg tracking-[0] leading-7 whitespace-nowrap">
                Online
              </span>
            </div>
        ...
        <Button
          ...
          className="w-[335px] h-auto flex items-center justify-center gap-2.5 px-[26px] py-3 bg-[#0072de] rounded-xl border border-solid border-[#8ab5dd] shadow-[0px_3px_4px_#00000040] hover:bg-[#005bb5]"
        >
